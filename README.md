...
手机浏览器优先的原创多人诈唬派对游戏。当前版本为 **V6.1**：2–8 人服务器权威诈唬核心循环，按 Match、Round、Turn 状态机推进，含分阶段质疑、翻牌、判定、独立左轮、淘汰、胜利、强化重连恢复、PWA 与部署资产。
...
- V6.0 只开放 Classic 和 Quick；Party、Custom、随机事件和道具暂时关闭。
