...
export const V7_PARTY_EVENT_TYPES = ['BLACKOUT', 'DRUNKEN', 'RAPID_NIGHT', 'DOUBLE_DANGER', 'NO_JOKER', 'FORCED_BET', 'ONE_CARD_ONLY', 'MATCH_BET', 'HEAVY_HAND', 'LAST_CALL'] as const;
